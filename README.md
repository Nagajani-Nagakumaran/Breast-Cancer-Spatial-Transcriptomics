...
```text
Breast-Cancer-Spatial-Transcriptomics/
│
├── R/
│   ├── 01_load_and_qc.R
│   ├── 02_normalisation_clustering.R
│   ├── 03_spatial_marker_analysis.R
│   ├── 04_cluster_annotation.R
│   └── 05_spatial_variability.R
│
├── figures/
│   └── analysis figures
│
...
│
├── pathology/
│   └── QuPath analysis outputs
│
├── .gitignore
├── Breast-Cancer-Spatial-Transcriptomics.Rproj
└── README.md
